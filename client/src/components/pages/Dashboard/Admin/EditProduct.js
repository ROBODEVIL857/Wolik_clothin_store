                    ...
                    <>
                        <form onSubmit={handleEdit}>
                            <Grid container spacing={2}>
                                <Grid item md={7} height='100%'>
                                    <Card variant="outlined" sx={{ p: 2, boxShadow: '0 3px 3px rgba(56,65,74,0.1)' }}>
                                        <Box>
                                            <Typography variant='body2' pb={1} fontWeight='600' color='#212529eb'>Назва товару</Typography>
                                            <TextField sx={{
                                                width: '100%',
                                    ...
                                    <Card variant="outlined" sx={{ p: 2, boxShadow: '0 3px 3px rgba(56,65,74,0.1)', mt: 3 }}>
                                        <Typography pb={1}>Галерея товарів</Typography>
                                        <Divider></Divider>
                                        <Box mt={2}>
                                ...
                                <Grid item xs={12} md={5} height='100%'>
                                    <Card variant="outlined" sx={{ p: 2, boxShadow: '0 3px 3px rgba(56,65,74,0.1)' }}>
                                        ...
                                        <Divider></Divider>
                                        <Typography variant='body2' py={2} fontWeight='600' color='#212529eb'>Виберіть бренд товару</Typography>
                                        <Select
                                    ...
                                    <Card variant="outlined" sx={{ p: 2, boxShadow: '0 3px 3px rgba(56,65,74,0.1)', mt: 2 }} >
                                        <Typography pb={1}> Категорії товарів </Typography>
                                        <Divider></Divider>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'flex-end', p: 2 }}>
                                <Button variant='contained' type='submit' sx={update}> Оновити </Button>
                            </Box>
                        </form>
                    </>
                }
