...
import { addToCart, getMe, trendingProducts } from '../../../Redux/actions';
...
const Trending = ({ products }) => {
    ...
    return (
        <Box sx={{ mx: { md: 16, xs: 4 }, mb: 10 }}>
            <Typography sx={{ textAlign: 'center', pt: 10, pb: 10, textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 'bold', fontSize: '26px' }}>
                Зараз у тренді
            </Typography>
            <Slider {...settings} >
                {
                                        ...
                                        product?.discount ?
                                            <Box sx={{
                                                ...
                                                <Typography gutterBottom variant="h6" sx={{
                                                    ...
                                                    грн. {+product.price - ((+product.price * +product.discount) / 100)}
                                                </Typography>
                                            </Box>
